...
DELIMITER $$
CREATE PROCEDURE Employee_Details (IN Emp_Details VARCHAR(50))
BEGIN 
	SELECT * FROM Employee WHERE Emp_Id = Emp_Details ;
END $$
DELIMITER ; 
-- Using Stored Procedure 
CALL Employee_Details (1005);

-- Creating View
CREATE VIEW Employees_Roll AS
SELECT Emp_Name, Department_Name 
FROM Employee ;
-- Using View
SELECT * FROM Employees_Roll ;
